...
% loading Data
  ...
  fprintf('loading source data ...\n' );
    ...
    %% compute stats for complete atlas: (for plotting, to have nice borders )
      ...
      % Check, if data is already avaliable
        ...
        if ~exist( fn_Stats_NoROIs, 'file' ) 
                ...
                Stats_NoROIs.name             = 'Stats_NoROIs';
                save( fn_NoROIs, 'Stats_NoROIs' )
    ...
    %        hier weitermachen
            ...
            fn_allROIs_left = strcat( DirFreqName, '\', 'Stats_allRois_left', '.mat' );
            save( fn_allROIs_left, 'Stats_allRois_left' )

            fn_allROIs_right = strcat( DirFreqName, '\', 'Stats_allRois_right', '.mat' );
            save( fn_allROIs_right, 'Stats_allRois_right' )

            fn_allROIs_both_hem = strcat( DirFreqName, '\', 'Stats_allRois_both_hem', '.mat' );
            save( fn_allROIs_both_hem, 'Stats_allRois_both_hem' )

            fn_allROIs_combined_hem = strcat( DirFreqName, '\', 'Stats_allRois_combined_hem', '.mat' );
            save( fn_allROIs_combined_hem, 'Stats_allRois_combined_hem' )
    ...
    fn_Broca_left = strcat( DirFreqName, '\', 'Stats_Broca_left', '.mat' );
    save( fn_Broca_left, 'Stats_Broca_left' )
  
    fn_Broca_right = strcat( DirFreqName, '\', 'Stats_Broca_right', '.mat' );
    save( fn_Broca_right, 'Stats_Broca_right' )
    
    fn_Broca_both_hem = strcat( DirFreqName, '\', 'Stats_Broca_both_hem', '.mat' );
    save( fn_Broca_both_hem, 'Stats_Broca_both_hem' )
    
    fn_Broca_combined_hem = strcat( DirFreqName, '\', 'Stats_Broca_combined_hem', '.mat' );
    save( fn_Broca_combined_hem, 'Stats_Broca_combined_hem' )
    ...
    fn_Wernicke_left = strcat( DirFreqName, '\', 'Stats_Wernicke_left', '.mat' );
    save( fn_Wernicke_left, 'Stats_Wernicke_left' )
  
    fn_Wernicke_right = strcat( DirFreqName, '\', 'Stats_Wernicke_right', '.mat' );
    save( fn_Wernicke_right, 'Stats_Wernicke_right' )
    
    fn_Wernicke_both_hem = strcat( DirFreqName, '\', 'Stats_Wernicke_both_hem', '.mat' );
    save( fn_Wernicke_both_hem, 'Stats_Wernicke_both_hem' )
    
    fn_Wernicke_combined_hem = strcat( DirFreqName, '\', 'Stats_Wernicke_combined_hem', '.mat' );
    save( fn_Wernicke_combined_hem, 'Stats_Wernicke_combined_hem' )
    ...
    fn_TemporalLobe_left = strcat( DirFreqName, '\', 'Stats_TemporalLobe_left', '.mat' );
    save( fn_TemporalLobe_left, 'Stats_TemporalLobe_left' )
  
    fn_TemporalLobe_right = strcat( DirFreqName, '\', 'Stats_TemporalLobe_right', '.mat' );
    save( fn_TemporalLobe_right, 'Stats_TemporalLobe_right' )
    
    fn_TemporalLobe_both_hem = strcat( DirFreqName, '\', 'Stats_TemporalLobe_both_hem', '.mat' );
    save( fn_TemporalLobe_both_hem, 'Stats_TemporalLobe_both_hem' )
    
    fn_TemporalLobe_combined_hem = strcat( DirFreqName, '\', 'Stats_TemporalLobe_combined_hem', '.mat' );
    save( fn_TemporalLobe_combined_hem, 'Stats_TemporalLobe_combined_hem' )
